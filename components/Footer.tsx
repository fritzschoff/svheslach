      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-yellow-500 rounded flex items-center justify-center font-oswald text-black font-bold text-xl">
                SVH
              </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-stone-800 rounded-full flex items-center justify-center hover:bg-yellow-500 hover:text-black transition-colors">
                <Instagram size={18} />
              </a>
              <a href="#" className="w-10 h-10 bg-stone-800 rounded-full flex items-center justify-center hover:bg-yellow-500 hover:text-black transition-colors">
                <Facebook size={18} />
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold uppercase mb-6 text-yellow-500">Navigation</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-bold uppercase mb-6 text-yellow-500">Kontakt</h4>
            <ul className="space-y-4 text-sm text-stone-400">
          ...
          {/* Newsletter / CTA */}
          <div>
            <h4 className="text-lg font-bold uppercase mb-6 text-yellow-500">Bleib am Ball</h4>
            ...
            <form className="flex">
              <input 
                ...
                className="bg-stone-800 border-none px-4 py-2 w-full text-sm focus:ring-1 focus:ring-yellow-500"
              />
              <button className="bg-yellow-500 text-black px-4 py-2 font-bold uppercase text-xs">OK</button>
            </form>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-stone-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-stone-500 uppercase tracking-widest">
          ...
          <div className="flex gap-8">
            <a href="#/impressum" className="hover:text-yellow-500">Impressum</a>
            <a href="#/datenschutz" className="hover:text-yellow-500">Datenschutz</a>
          </div>
        </div>
      </div>
    </footer>
